...
public class MainWindow extends JFrame implements ActionListener, WindowListener {
     ...
     *
     * @param manager the {@link project.pc.net.NetworkManager} for
     *                this network.
     */
     ...
     * @param st the {@link project.pc.net.ServerThread} which handles
     *           this client.
     ...
     *              client.
     * @param st the {@link project.pc.net.ServerThread} which handles this
     *           client.
     * @see project.pc.net.ServerThread
     */
