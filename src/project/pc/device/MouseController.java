...
import project.pc.sensor.SensorDataHandler;
 ...
 * @see project.pc.device.MouseMove#moveRelatively(Robot, int, int, float)
 */
...
public class MouseController {
     ...
     * the mobile device.
     *
     * @param quaternion a {@link project.pc.sensor.representation.Quaternion}
     *                   object.
